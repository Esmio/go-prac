...
INSERT INTO users (email) VALUES ($1) RETURNING id, email, phone, address, created_at, updated_at
`
...
SELECT id, email, phone, address, created_at, updated_at FROM users WHERE id = $1
`
...
SELECT id, email, phone, address, created_at, updated_at FROM users WHERE email = $1
`
...
SELECT id, email, phone, address, created_at, updated_at FROM users WHERE phone = $1
`
